...
int Distance::getDistance() { return getSensorValue(_queryDis, 8, 3); }
...
int Soild3in1 ::getHumidity() { return getSensorValue(_queryTemHum, 10, 3); }
int Soild3in1 ::getTemperature() { return getSensorValue(_queryTemHum, 10, 5); }
int Soild3in1 ::getPH() { return getSensorValue(_queryPH, 8, 3); }
...
int Soild7in1 ::getHumidity() { return getSensorValue(_queryTemHum, 10, 3); }
int Soild7in1 ::getTemperature() { return getSensorValue(_queryTemHum, 10, 5); }
int Soild7in1 ::getPH() { return getSensorValue(_queryPH, 8, 3); }
int Soild7in1 ::getNito() { return getSensorValue(_queryN, 8, 3); }
int Soild7in1 ::getPhotpho() { return getSensorValue(_queryP, 8, 3); }
int Soild7in1 ::getKali() { return getSensorValue(_queryK, 8, 3); }
int Soild7in1 ::getEC() { return getSensorValue(_queryEC, 8, 3); }
